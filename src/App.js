  ...
  render() {
    return (
      <div className="main-section ">
        < h1 > Input your desired time in minutes</ h1 >
        <img src="https://images-eu.ssl-images-amazon.com/images/I/61hr%2Bn3DI6L.png">
        </img>
        <input className="clock-holder " type="number" value={this.props.value} onChange={this.props.handleChange} required />
      </div >
    );
  }
}
  ...
  render() {
    return (
      ...
      <div className="main-section ">
        ...
        <h2>hours={this.props.value / (60)} </h2>
        <h2>seconds={this.props.value * (60)} </h2>
      </div>
    );
  }
}
